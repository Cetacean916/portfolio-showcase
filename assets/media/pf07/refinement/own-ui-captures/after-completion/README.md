...
아래 파일은 동결된 한·영 UI와 최종 공개 build `pf07-build-b99af2ac12d22b464865`의 정확한 CI·Release·Linux 실행 사실에 맞춰 공개 경계를 검토했습니다.
...
- `CASE-020`: commit `97d40c7`의 성공한 public GitHub Actions run `29972236888`과 `pf07-canonical-packages-1.0.2` 산출물 실제 화면
