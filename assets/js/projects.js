    ...
    refinement: {
      ...
      locales: {
        ko: {
          ...
          evidenceTitle: "소스와 공개 근거", evidenceIntro: "영상·점수표가 어떤 실행 근거에 결속되는지 구매자가 직접 확인할 수 있습니다.", evidenceLabels: ["공개 소스", "10-gate evidence index", "WordPress tests", "n8n workflow", "복구 runbook", "실행 영상 무결성 기록"], evidenceAction: "열기 ↗",
        ...
        en: {
          ...
          evidenceTitle: "Source and public evidence", evidenceIntro: "Buyers can verify how the videos and scorecard bind to executable evidence.", evidenceLabels: ["Public source", "10-gate evidence index", "WordPress tests", "n8n workflow", "Recovery runbook", "Execution-video integrity record"], evidenceAction: "Open ↗",
