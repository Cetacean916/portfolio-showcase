window.PORTFOLIO_PROJECTS = [
  ...
  },
  {
    ...
    refinement: {
      ...
      currentCandidate: {
        buildId: "pf07-build-e6996fd41e28b1ac42b8",
        artifactSetSha256: "1609690b2688f8ee00f43b83d24194465b0d0055aeeeee1487937c9832d025be",
        publicationState: "LOCAL_CANDIDATE_NOT_PUBLISHED",
        publishedBaselineTag: "pf07-v1.0.0"
      },
      ...
      locales: {
        ko: {
          ...
          sourceAction: "공개 소스 보기", releaseAction: "기존 1.0.0 배포판 보기", languageLabel: "언어", facts: [["2", "전달 모드"], ["6", "자동 시도 상한"], ["KO ↔ EN", "동일 상점 런타임"]],
          ...
          packageTitle: "전달 환경에 맞는 진입점", packageIntro: "아래 다운로드는 변경 불가한 기존 pf07-v1.0.0 공개 기준선입니다. 이 페이지의 OFFSET 재설계는 build e6996fd41e28b1ac42b8 로컬 후보이며, 기존 태그를 덮어쓰지 않았습니다.",
          ...
          finalProofTitle: "기존 공개 1.0.0 기준선", finalProofIntro: "아래 수치는 이전 immutable release의 이력입니다. 현재 OFFSET 후보의 공개 CI·새 배포판 근거로 재사용하지 않습니다.", finalProofLabels: ["이전 canonical Linux 복원·재실행 · 5/5 Ready", "이전 5개 플랫폼 배포 산출물·진입점·실행 경계", "이전 관측 점수표 · 브라우저 580/580 · GATE-10 복원 PASS · Release 10/10", "이전 commit 5488672 public CI success · canonical artifact"],
        ...
        en: {
          ...
          sourceAction: "View public source", releaseAction: "View published 1.0.0 baseline", languageLabel: "Language", facts: [["2", "delivery modes"], ["6", "automatic-attempt cap"], ["KO ↔ EN", "same store runtime"]],
          ...
          packageTitle: "An entry point for each delivery environment", packageIntro: "The downloads below are the immutable earlier pf07-v1.0.0 public baseline. The OFFSET redesign shown here is local candidate build e6996fd41e28b1ac42b8; the accepted tag has not been overwritten.",
          ...
          finalProofTitle: "Earlier published 1.0.0 baseline", finalProofIntro: "These facts belong to the earlier immutable release. They are not reused as public CI or release proof for the current OFFSET candidate.", finalProofLabels: ["Earlier canonical Linux restore and rerun · 5/5 Ready", "Earlier five-platform artifacts, entrypoints, and boundaries", "Earlier scorecard · 580/580 browser checks · GATE-10 restore PASS · 10/10 Release assets", "Earlier commit 5488672 public CI success · canonical artifact"],
