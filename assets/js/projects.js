    ...
    refinement: {
      ...
      locales: {
        ko: {
          ...
          finalProofTitle: "복원부터 공개 배포까지, 마지막 사실", finalProofIntro: "PF07 release commit 이후에만 생길 수 있는 복원·플랫폼·검증·CI 증거를 showcase-only 산출물로 분리했습니다.", finalProofLabels: ["최종 canonical Linux 복원·재실행 · 5/5 Ready", "5개 플랫폼 배포 산출물·진입점·실행 경계", "최종 관측 점수표 · 브라우저 580/580 · Release 10/10", "commit 5488672 public CI success · canonical artifact"],
