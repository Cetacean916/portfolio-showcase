window.PORTFOLIO_PROJECTS = [
  ...
  },
  {
    ...
    refinement: {
      ...
      currentDelivery: {
        buildId: "pf07-build-13003091bee3a5201dba",
        artifactSetSha256: "6ef2ca1d0c2f4ba783181c3e5d59dfb02e535ab9435aab82e66f140f07829926",
        publicationState: "PUBLIC_PACKAGE_RELEASE_PASS",
        releaseTag: "pf07-v1.0.1",
        immutablePredecessorTag: "pf07-v1.0.0"
      },
      releaseUrl: "https://github.com/Cetacean916/oddroom-woo-orderops/releases/tag/pf07-v1.0.1",
      releaseAssets: [
        { filename: "pf07-windows-x64-1.0.1.zip", url: "https://github.com/Cetacean916/oddroom-woo-orderops/releases/download/pf07-v1.0.1/pf07-windows-x64-1.0.1.zip", sha256: "59d2391b1fa67b33ddfd3fad9f6bb665118d0f98a026ee662fe8d124b20f6444" },
        { filename: "pf07-windows-kvm-test-kit-1.0.1.zip", url: "https://github.com/Cetacean916/oddroom-woo-orderops/releases/download/pf07-v1.0.1/pf07-windows-kvm-test-kit-1.0.1.zip", sha256: "9aff25538b04dc6248fa5fbc7acef1b01c3ecba4dd1ab51e1c12982649066f81" },
        { filename: "pf07-macos-universal-1.0.1.zip", url: "https://github.com/Cetacean916/oddroom-woo-orderops/releases/download/pf07-v1.0.1/pf07-macos-universal-1.0.1.zip", sha256: "eea0d8b1a147c33fe70fa3bc57d495e4336d9101fd859ebcb5ca3e276d8912f2" },
        { filename: "pf07-linux-x86_64-1.0.1.tar.gz", url: "https://github.com/Cetacean916/oddroom-woo-orderops/releases/download/pf07-v1.0.1/pf07-linux-x86_64-1.0.1.tar.gz", sha256: "a6a98ab573b301b49477621dc9a36bfa5b43d10bc9d755968a25bf1372628a80" },
        { filename: "pf07-linux-server-1.0.1.tar.gz", url: "https://github.com/Cetacean916/oddroom-woo-orderops/releases/download/pf07-v1.0.1/pf07-linux-server-1.0.1.tar.gz", sha256: "0df834d9f53484367eb74eede3692cd122fdfceee37b3408639554387904aeb6" }
      ],
      evidenceUrls: [
      ...
      locales: {
        ko: {
          ...
          sourceAction: "공개 소스 보기", releaseAction: "1.0.1 배포판 보기", languageLabel: "언어", facts: [["2", "전달 모드"], ["6", "자동 시도 상한"], ["KO ↔ EN", "동일 상점 런타임"]],
          ...
          packageTitle: "전달 환경에 맞는 진입점", packageIntro: "아래 다운로드는 final CI와 공개 readback이 일치한 pf07-v1.0.1 exact assets입니다. Linux는 canonical 바이트를 실제 실행했고 Windows·macOS는 명시된 artifact 검증 경계를 유지합니다.",
          ...
          finalProofTitle: "공개 1.0.1 전달 증거", finalProofIntro: "아래 파생물은 최종 복원·플랫폼 산출물·관측 점수·public CI를 새 1.0.1 바이트와 태그에 직접 결속합니다.", finalProofLabels: ["canonical Linux 복원·재실행 · 5/5 Ready", "5개 플랫폼 배포 산출물·진입점·실행 경계", "관측 점수표 · 브라우저 580/580 · GATE-10 복원 PASS · Release 10/10", "commit 0279394 public CI success · canonical artifact 1.0.1"],
          ...
          evidenceTitle: "소스와 공개 근거", evidenceIntro: "영상·점수표가 어떤 실행 근거에 결속되는지 구매자가 직접 확인할 수 있습니다.", evidenceLabels: ["공개 소스", "10-gate evidence index", "WordPress tests", "n8n workflow", "복구 runbook", "1.0.1 Release manifest", "실행 영상 무결성 기록"], evidenceAction: "열기 ↗",
        ...
        en: {
          ...
          sourceAction: "View public source", releaseAction: "View release 1.0.1", languageLabel: "Language", facts: [["2", "delivery modes"], ["6", "automatic-attempt cap"], ["KO ↔ EN", "same store runtime"]],
          ...
          packageTitle: "An entry point for each delivery environment", packageIntro: "These are the exact pf07-v1.0.1 assets matched between final CI and public readback. Canonical Linux bytes were executed; Windows and macOS retain their stated artifact-validation boundaries.",
          ...
          finalProofTitle: "Published 1.0.1 delivery evidence", finalProofIntro: "These derivatives bind the final restore, platform artifacts, observed scorecard, and public CI directly to the new 1.0.1 bytes and tag.", finalProofLabels: ["Canonical Linux restore and rerun · 5/5 Ready", "Five platform artifacts, entrypoints, and execution boundaries", "Observed scorecard · 580/580 browser checks · GATE-10 restore PASS · 10/10 Release assets", "Commit 0279394 public CI success · canonical artifact 1.0.1"],
